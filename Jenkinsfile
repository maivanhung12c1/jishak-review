        ...
        stage("Create New Pods") {
            steps {
                withKubeCredentials(
                    kubectlCredentials: [[
                        caCertificate: '',
                        clusterName: 'arn:aws:eks:ap-southeast-1:009530452853:cluster/jishakamiapp',
                        contextName: 'arn:aws:eks:ap-southeast-1:009530452853:cluster/jishakamiapp',   // Cluster ARN
                        credentialsId: 'jenkins-k8s-token',
                        namespace: 'production',
                        serverUrl: 'https://64DB7CE93857DB666582B431A018C9A7.gr7.ap-southeast-1.eks.amazonaws.com'   // API server endpoint
                    ]]
                ) {
                    script {
